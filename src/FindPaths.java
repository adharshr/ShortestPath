...
public class FindPaths {
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            List<Vertex> vertices = myPath.vertices;
            
            if(myPath == null) {
                System.out.println("does not exist");
            } else if(vertices.size() == 1) {
                System.out.println("Shortest path from " + a.getLabel() + " to itself:");
                System.out.println(vertices.get(0));
                System.out.println("Cost of path: " + myPath.cost);
            } else {
